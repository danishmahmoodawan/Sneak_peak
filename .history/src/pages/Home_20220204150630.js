	...
	<div class="container">
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-6 col-sm-6 adj_col "> <img class="mb-3" src="assets/images/image1.svg" alt=""> <img class="mt-3" src="assets/images/image2.svg" alt=""> </div>
				<div class="col-md-6 col-sm-6">
					<div class="main_row row_bg count_call">
						...
						<div class="row">
							<div class="col-3 cent_icon">
								<a href="#"><img src="assets/images/plus.svg" alt=""></a>
							</div>
							<div class="col-6 p-0">
								<h1 class="counted">5</h1></div>
							<div class="col-3 cent_icon">
...
<section class="second_section">
	<div class="container-fluid">
		<div class="col_img "><img src="assets/images/image_bg_1.svg" alt="featured image"> <img class="ml-2 mr-2" src="assets/images/image_bg_2.svg" alt="featured image"> <img src="assets/images/image_bg_3.svg" alt=" featured image"> </div>
	</div>
</section>
	...
	<div class="container text-center">
		...
		<div class="row mt-3 mb-3">
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set">COMMON</h3> </div>
				</div>
				<div class="text_captioned ">
					<h3 class="text_set_cap">3000/16000 ( 20% )</h3> </div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set uncomon">UNCOMMON</h3> </div>
				</div>
			...
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set rare">RARE</h3> </div>
				</div>
				<div class="text_captioned text-center">
					<h3 class="text_set_cap">3000/16000 ( 20% )</h3> </div>
			</div>
		...
		<div class="row mt-3 mb-3">
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set uniq">UNIQUE</h3> </div>
				</div>
				<div class="text_captioned ">
					<h3 class="text_set_cap">3000/16000 ( 20% )</h3> </div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set epic">EPIC</h3> </div>
				</div>
				<div class="text_captioned text-center">
					<h3 class="text_set_cap">3000/16000 ( 20% )</h3> </div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="box_image"> <img src="assets/images/image_common.svg" alt="Flying Kites">
					<div class="text_image">
						<h3 class="text_set legnd">LEGEND</h3> </div>
				</div>
				<div class="text_captioned text-center">
					<h3 class="text_set_cap">3000/16000 ( 20% )</h3> </div>
			</div>
			  ...
			  <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
					...
					<i class="fas fa-sort-down"></i>  </button>
						...
						<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body"> SOME ANSWER SOME ANSWER, SOME TEXT, SOME ANSWERS, SOME TEXT, SOME ANSWERS, SOME TEXT </div>
						</div>
					</div>
					<div class="card">
